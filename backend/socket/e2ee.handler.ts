  ...
  socket.on("e2ee:message:send", async (payload: E2EESendPayload) => {
    ...
    try {
      ...
      const message = await Message.create({
        ...
        content: undefined,
        isE2ee: true,
        e2eeCipher: cipherText,
        e2eeIv: iv,
        e2eeTag: tag,
        isStealth,
        stealthExpiresAt,
        stealthContentLength: isStealth ? (cipherText.length) : undefined,
        mediaUrl,
        fileName,
        fileSize,
