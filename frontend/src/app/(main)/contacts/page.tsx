        ...
        <div className="p-4 border-b border-border/30 shrink-0 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-muted-foreground">
              {requests.length > 0 && (
                <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-primary text-primary-foreground text-[10px] font-semibold ml-1">
                  {requests.length}
                </span>
              )}
            </span>
            ...
            <div>
              {isLoadingRequests ? (
                ...
                <div className="flex flex-col items-center justify-center py-16 text-center px-4">
                  ...
                  <p className="text-xs text-muted-foreground">New contact requests will appear here.</p>
                </div>
              ) : (
                requests.map((req) => (
                  <ContactRequestCard
